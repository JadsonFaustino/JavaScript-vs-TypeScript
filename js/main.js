function getPerformance(func) {
    ...
    return {
        ...
        runtime_unit: "ms",
        memoryUsed: parseFloat(memoryUsedMB),
        memoryUsed_unit: "MB"
    };
}

function measurePerformance(func, times = 10) {
    let total_time = 0;
    let total_memory = 0;
    for (let i = 0; i < times; i++) {
        res = getPerformance(func);
